...
```javascript
const ws = new WebSocket('ws://localhost:8007/api/v1/xray/ws');
...
curl http://localhost:8007/api/v1/xray/

# Получить статистику
curl http://localhost:8007/api/v1/xray/stats

# Получить активные сессии
curl http://localhost:8007/api/v1/xray/active
```
