...
Persona is a personality system with eight traits: curiosity, helpfulness, adaptability, creativity, skepticism, empathy, caution, openness.

**What it includes:**
- Numeric trait values (0.0–1.0) with per-trait stability
- Values and principles
- Communication style
- History of self-reflections

Persona evolves: after each dialogue, traits may shift slightly. Evolution preserves the personality core — changes accumulate gradually.

---

### RAG

RAG v3.0 is semantic memory on PostgreSQL with hybrid search.

**Capabilities:**
- Topic classification (7 categories: technical, philosophical, personal, educational, creative, analytical, everyday)
- Entity extraction (6 types: person, technology, concept, location, time, number)
- Relation extraction between entities (is_a, uses, related_to, part_of, contains)
- Hybrid search: keywords + recency + semantic similarity
- LLM summarization (optional, via GigaChat)
- Filtering by user and topic
