...
# Alias для совместимости с тестами (тесты ожидают get_current_user в core.auth_manager)
# В продакшене используется get_current_user_safe с поддержкой refresh_token
async def get_current_user(
    authorization: Optional[str] = Header(None),
    x_refresh_token: Optional[str] = Header(None, alias="X-Refresh-Token")
) -> Dict[str, Any]:
    """Alias для get_current_user_safe для совместимости с тестами"""
